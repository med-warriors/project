...
import CurrentMedicineGuest from '../components/CurrentMedicineGuest';
import CurrentSuppliesGuest from '../components/CurrentSuppliesGuest';
...
const MedicineAndSuppliesGuest = ({ readyM, medicines, readyS, supplies }) => {
      ...
      <Tab panes={[
        {
          ...
          menuItem: 'Medicine', render: () => <Tab.Pane>
            ...
            <Table>
              ...
              <Table.Body>
                {medSort.map((medicine) => <CurrentMedicineGuest key={medicine._id} medicine={medicine}/>).slice(medStart, medEnd)}
              </Table.Body>
            </Table>
            <Pagination
              boundaryRange={0}
        ...
        },
        {
          ...
          menuItem: 'Supplies', render: () => <Tab.Pane>
            ...
            <Table>
              ...
              <Table.Body>
                {supplySort.map((supply) => <CurrentSuppliesGuest key={supply._id} supply={supply}/>).slice(supplyStart, supplyEnd)}
              </Table.Body>
            </Table>
            <Pagination
              boundaryRange={0}
...
MedicineAndSuppliesGuest.propTypes = {
